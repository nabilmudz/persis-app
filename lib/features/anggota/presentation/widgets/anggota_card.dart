...
class AnggotaCard extends StatelessWidget {
  ...
  const AnggotaCard({super.key, required this.transaction});
  ...
  Widget build(BuildContext context) {
    ...
    final isLunas =
        transaction.status != 'pending' && transaction.status != 'tunggakan';
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: isLunas ? const Color(0xFF074D2C) : Colors.red,
                width: 1,
              ),
