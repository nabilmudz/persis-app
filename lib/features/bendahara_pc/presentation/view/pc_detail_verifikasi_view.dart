                  ...
                  children: const [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Perlu Persetujuan PC',
                            style: TextStyle(
                              color: Color(0xFFB95E04),
                              fontFamily: 'Poppins',
                              fontSize: 14,
                          ...
                          SizedBox(height: 6),
                          Text(
                            'Mohon periksa kecocokan dana yang masuk ke rekening PC sebelum menekan tombol Verifikasi.',
                            style: TextStyle(
                              color: Color(0xFFB95E04),
                              fontFamily: 'Poppins',
                              fontSize: 11,
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  _buildDetailRow('Metode', item.paymentMethod, isBold: true),
                  const Divider(height: 32, color: Color(0xFFEEEEEE)),
                  _buildDetailRow('Tanggal', item.date, isBold: true),
                  const Divider(height: 32, color: Color(0xFFEEEEEE)),
                  Row(
