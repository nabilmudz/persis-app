...
import 'package:persis_app/features/bendahara_pj/presentation/widgets/pj_verification_member_card.dart';
import 'package:persis_app/features/bendahara_pj/presentation/view/tunai/pj_verif_tunai_view.dart';
...
import 'package:persis_app/features/bendahara_pj/presentation/view/anggota/pj_detail_anggota_view.dart';
  ...
  static TransactionModel _buildTransactionFromHive(Map<String, dynamic> data) {
    try {
      ...
      return TransactionModel(
        ...
        totalAmount: () {
          final t = data['totalAmount'] ?? data['total_amount'];
